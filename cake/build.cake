...
// Setup publish dir using git versioning
var projectDir = "../Picturepark.ContentPortal.Demo/Picturepark.ContentPortal.Demo/";
  ...
  .Does(() =>
{
    ...
    DotNetCorePublish(
        projectDir + "Picturepark.ContentPortal.Demo.csproj", 
